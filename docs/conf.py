...
"""
coursebank-features documentation build configuration file.
...
project = 'coursebank-features'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'coursebank-features'
...
#
# html_title = 'coursebank-features v0.1.0'
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'coursebank_features'),
                os.path.join(root_path, 'coursebank_features/migrations')])
